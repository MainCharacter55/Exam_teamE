        ...
        <section class="me-4">
            ...
            <form action="StudentCreateExecute.action" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select w-100" id="student-ent-year-input" name="ent_year" required>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control w-100" type="text" id="student-no-input" name="no" 
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control w-100" type="text" id="student-name-input" name="name" 
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select w-100" id="student-class-num-input" name="class_num" required>
